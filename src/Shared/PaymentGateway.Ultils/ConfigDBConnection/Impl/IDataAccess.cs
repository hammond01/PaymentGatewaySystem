...
public interface IDataAccess
{
    ...
    Task<bool> UpdateData<TP>(string tableName, long updatedId, TP parameters, string connectionId = "SQL");
    Task<bool> DeleteData<TP>(string tableName, TP parameters, string connectionId = "SQL");
    Task<bool> DeleteDataFromClient(string tableName, long deteledId, string connectionId = "SQL");
